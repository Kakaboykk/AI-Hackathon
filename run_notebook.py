#!/usr/bin/env python3
"""
Script to run the appliances energy prediction notebook
"""
...
print("\n12. Plotting final training losses...")
...
# Plot some forecasts
print("\n14. Plotting forecast results...")

# Plot appliances forecast
plt.figure(figsize=(12, 6))
true_forecast_df['Appliances'].plot()
plt.title('Appliances Energy Forecast')
plt.xlabel('Date')
plt.ylabel('Energy Consumption')
plt.savefig('appliances_forecast.png')
plt.show()

# Plot windspeed forecast with historical data
plt.figure(figsize=(16, 8))
df['Windspeed'].iloc[-4032:].plot(label='Historical Windspeed')
true_forecast_df['Windspeed'].plot(label='Forecast Windspeed')
plt.legend()
plt.title('Windspeed: Historical vs Forecast')
plt.xlabel('Date')
plt.ylabel('Windspeed')
plt.savefig('windspeed_forecast.png')
plt.show()
...
print("- training_losses.png (training loss plot)")
print("- final_training_losses.png (final model loss plot)")
print("- appliances_forecast.png (appliances forecast)")
print("- windspeed_forecast.png (windspeed forecast)")
print("=" * 50)
